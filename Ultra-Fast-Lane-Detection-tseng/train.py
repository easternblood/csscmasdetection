...
if __name__ == "__main__":
    ...
    print("cls_dim",cfg.griding_num + 1, cls_num_per_lane, 4)
    net = parsingNet(pretrained=False, backbone=cfg.backbone, cls_dim=(cfg.griding_num + 1, cls_num_per_lane, 4), use_aux=cfg.use_aux).cuda()
    ...
    for epoch in range(resume_epoch, cfg.epoch):
        ...
        if (epoch + 1) % 10 == 0:
            save_model(net, optimizer, epoch, work_dir)
    logger.close()
